...
type Interface interface {
	...
	CreateSnapshot(ctx context.Context, name string, volumeID string, zone scw.Zone) (*block.SnapshotSummary, error)
	...
	GetSnapshot(ctx context.Context, snapshotID string, zone scw.Zone) (*block.SnapshotSummary, error)
	GetSnapshotByName(ctx context.Context, name string, sourceVolumeID string, zone scw.Zone) (*block.SnapshotSummary, error)
	...
	ListSnapshots(ctx context.Context, start uint32, max uint32) ([]*block.SnapshotSummary, string, error)
	ListSnapshotsBySourceVolume(ctx context.Context, start uint32, max uint32, sourceVolumeID string, sourceVolumeZone scw.Zone) ([]*block.SnapshotSummary, string, error)
	...
	WaitForSnapshot(ctx context.Context, snapshotID string, zone scw.Zone) (*block.SnapshotSummary, error)
}
